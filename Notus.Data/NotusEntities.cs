...
using Notus.Data.Configuration;
using Notus.Model.Models;

namespace Notus.Data
{
    public class NotusEntities : IdentityDbContext<ApplicationUser>
    {
        public NotusEntities()
            : base("NotusEntities")
        {
        }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //Deprecated API so it's removed but don't know why this is here
