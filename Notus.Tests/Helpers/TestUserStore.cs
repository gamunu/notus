...
{
    public class TestUserStore : IUserStore<ApplicationUser>, IUserLoginStore<ApplicationUser>,
        IUserRoleStore<ApplicationUser>, IUserClaimStore<ApplicationUser>, IUserPasswordStore<ApplicationUser>,
        IUserSecurityStampStore<ApplicationUser>
    {
        private readonly Dictionary<IdentityUserLogin, ApplicationUser> _logins =
            new Dictionary<IdentityUserLogin, ApplicationUser>();
            ...
            {
                {
                    ...
                    new ApplicationUser
                    {
                        FirstName = "Sharon",
                        UserName = "Sharon",
                        Id = "15e8cda1-3ea3-473d-902f-b62aa55816db"
                    }
                },
                {
                    "TestUser2",
                    new ApplicationUser
                    {
                        FirstName = "adarsh",
                        UserName = "adarsh",
                        Id = "67e6yda1-3ea3-473d-902f-b62er55816db"
                    }
                },
                {
                    "TestUser3",
                    new ApplicationUser
                    {
                        FirstName = "Shiju",
                        UserName = "Shiju",
                        Id = "78e5fda1-3ea3-473d-902f-b62aa86716db"
                    }
                }
            };
        }
