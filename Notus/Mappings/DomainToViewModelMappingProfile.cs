...
using Notus.Web.Core.AutoMapperConverters;
using PagedList;
...
namespace Notus.Mappings
{
    public class DomainToViewModelMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            ...
            Mapper.CreateMap<Goal, GoalListViewModel>()
            ...
            Mapper.CreateMap<Group, GroupsItemViewModel>()
                .ForMember(x => x.CreatedDate, opt => opt.MapFrom(source => source.CreatedDate.ToString("dd MMM yyyy")));

            Mapper.CreateMap<IPagedList<Group>, IPagedList<GroupsItemViewModel>>()
                .ConvertUsing<PagedListConverter<Group, GroupsItemViewModel>>();
