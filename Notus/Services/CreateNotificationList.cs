...
namespace Notus.Services
{
    ...
    {
        internal IEnumerable<NotificationsViewModel> GetNotifications(string userId, IGoalService goalService,
            ICommentService commentService, IUpdateService updateService, ISupportService supportService,
            IUserService userService, IGroupService groupService, IGroupUserService groupUserSevice,
            IGroupGoalService groupGoalService, IGroupCommentService groupcommentService,
            IGroupUpdateService groupupdateService, IFollowUserService followUserService,
            IGroupCommentUserService groupCommentUserService, ICommentUserService commentUserService,
        ...
        internal IEnumerable<NotificationsViewModel> GetProfileNotifications(string userid, IGoalService goalService,
            ICommentService commentService, IUpdateService updateService, ISupportService supportService,
            IUserService userService, IGroupService groupService, IGroupUserService groupUserSevice,
            IGroupGoalService groupGoalService, IGroupCommentService groupcommentService,
            IGroupUpdateService groupupdateService, ICommentUserService commentUserService)
        {
        ...
        private string DateCalculation(DateTime CreatedDate)
        {
            ...
            var creDate = CreatedDate.ToShortDateString();
            ...
            if (creDate == dateNow)
            {
                if (duration.Hours >= 1)
                {
                    if (duration.Hours == 1)
                    {
                        return notificationdate = duration.Hours + " " + "Hour Ago";
                    }
                    return notificationdate = duration.Hours + " " + "Hours Ago";
                }
                if (duration.Minutes >= 1)
                {
                    if (duration.Minutes == 1)
                    {
                        return notificationdate = duration.Minutes + " " + "Minute Ago";
                    }
                    return notificationdate = duration.Minutes + " " + "Minutes Ago";
                }
            ...
            {
                return notificationdate = duration.Days + " " + "Day Ago";
            }
            return notificationdate = duration.Days + " " + "Days Ago";
